...
\begin{footnotesize}
\begin{longtable}{|p{0.15\linewidth}|p{0.19\linewidth}|p{0.19\linewidth}|p{0.19\linewidth}|p{0.22\linewidth}|}
	\hline
	...
	\endhead
	\hline
	\caption{Theoretical Framework Synthesis}
	\label{tab:theoretical_synthesis}
	\endlastfoot
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.95\textwidth]{SAIL Framework_ AI Lebenszyklusmodell.png}
	\caption{SAIL Framework: Strategic AI Lifecycle Model - Eight-stage lifecycle with governance layer and feedback loops}
	\label{fig:sail-framework}
\end{figure}
...
\begin{longtable}{|p{0.17\linewidth}|p{0.27\linewidth}|p{0.10\linewidth}|p{0.16\linewidth}|p{0.30\linewidth}|}
	\hline
	\textbf{Stage} &
	...
	\endhead
	\hline
	\caption{SAIL Framework Decision Checkpoints}
	\label{tab:decision_checkpoints}
	\endlastfoot
...
\begin{longtable}{|p{0.36\linewidth}|p{0.64\linewidth}|}
	\hline
	...
	\endhead
	\hline
	\caption{Selected Use Cases for SAIL Validation}
	\label{tab:selected_use_cases}
	\endlastfoot
...
\begin{longtable}{|p{0.4\linewidth}|p{0.6\linewidth}|}
	...
	\endhead
	\hline
	\caption{Code Documentation: Measurement Methods}
	\label{tab:doc_gen_metrics}
	\endlastfoot
...
\begin{longtable}{|p{0.4\linewidth}|p{0.6\linewidth}|}
	...
	\endhead
	\hline
	\caption{Code Documentation: Results Achieved}
	\label{tab:doc_gen_results}
	\endlastfoot
...
\begin{longtable}{|p{0.4\linewidth}|p{0.6\linewidth}|}
	...
	\endhead
	\hline
	\caption{AI-driven Refactoring: Measurement Methods}
	\label{tab:refactor_metrics}
	\endlastfoot
...
\begin{longtable}{|p{0.4\linewidth}|p{0.6\linewidth}|}
	...
	\endhead
	\hline
	\caption{AI-driven Refactoring: Pilot Stage Results}
	\label{tab:refactor_pilot_results}
	\endlastfoot
...
\begin{longtable}{|p{0.4\linewidth}|p{0.6\linewidth}|}
	...
	\endhead
	\hline
	\caption{AI-driven Refactoring: Final Results}
	\label{tab:refactor_final_results}
	\endlastfoot
...
\begin{longtable}{|p{0.4\linewidth}|p{0.6\linewidth}|}
	...
	\endhead
	\hline
	\caption{Pull Request Review: Measurement Methods}
	\label{tab:pr_review_metrics}
	\endlastfoot
...
\begin{longtable}{|p{0.4\linewidth}|p{0.6\linewidth}|}
	...
	\hline
	\caption{Pull Request Review Automation: Final Results}
	\label{tab:pr_review_final_results}
	\endlastfoot
...
\begin{longtable}{|p{0.22\linewidth}|p{0.30\linewidth}|p{0.42\linewidth}|}
	...
	\hline
	\caption{Summary of Impact Across All Use Cases}
